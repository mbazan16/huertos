...
@WebServlet("/maceta/r")
public class MacetaDeleteController extends BaseController {
	private static final long serialVersionUID = 1L;

	MacetasService service;

	private static final Logger log = Logger.getLogger(MacetaDeleteController.class);

	public MacetaDeleteController() {
		super();

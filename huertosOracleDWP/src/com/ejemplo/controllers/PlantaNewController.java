...
@WebServlet("/planta/n")
public class PlantaNewController extends BaseController {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if(request.getParameter("idMaceta")!=null 
					&& !"".equalsIgnoreCase((request.getParameter("idMaceta").trim()))) { 
				idMaceta = Long.valueOf(request.getParameter("idMaceta"));
			}
			String nombre = request.getParameter("nombre");
			
			service.generatePlanta(idMaceta,nombre);		

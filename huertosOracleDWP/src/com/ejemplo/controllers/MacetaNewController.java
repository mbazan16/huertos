...
@WebServlet("/maceta/n")
public class MacetaNewController extends BaseController {
	private static final long serialVersionUID = 1L;

	MacetasService service;

	private static final Logger log = Logger.getLogger(MacetaNewController.class);

	public MacetaNewController() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			service.generateMaceta(idHuerto,codigo,tamanio,material);

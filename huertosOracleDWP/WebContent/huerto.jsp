...
<body>
	...
	<section id="smodificar" style="display: none;">
		...
		<form id="fmodificar" method="post" action="${context}/huerto/m">
	...
	<section id="seliminar" style="display: none;">
		<form id="feliminar" method="post" action="${context}/huerto/r">
			<input hidden="true" type="text" name="id" value="${huerto.id}" />
		</form>
	</section>
		...
		<caption><fmt:message key="listado.macetas"/></caption>
			...
			<c:forEach items="${macetas}" var="maceta">
				<tr>
					...
					<td><a href="${context}/maceta/v?id=${maceta.id}"><img src="https://img.icons8.com/color/search" width=15 height=15></a></td>
				</tr>
			</c:forEach>
		</table>
	</section>
	...
	<section id="snuevo" class="modal">
		...
		<form id="fnuevo" method="post" action="${context}/maceta/n">
			<input hidden="true" type="text" name="forward" value="/huerto/v" />
			<input hidden="true" type="text" name="idHuerto" value="${huerto.id}" />

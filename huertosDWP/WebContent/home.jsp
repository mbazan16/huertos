...
<body>
		...
		<table id="tlistado">
			...
			<c:forEach items="${huertos}" var="huerto">
				<tr>
					...
					<a href="${context}/huerto/r?id=${huerto.idHuerto}"><img src="https://img.icons8.com/color/48/000000/waste--v1.png" width=15 height=15/></a>
					</td>
				</tr>
			</c:forEach>
		</table>
	...
	<section id="snuevo">
		...
		<form id="fnuevo" method="post" action="${context}/huerto/n">
			<input hidden="true" type="text" name="forward" value="/" />

		...
		<table id="tlistado">
			...
			<c:forEach items="${macetas}" var="maceta">
				<tr>
					...
					<td><a href="${context}/maceta/${maceta.id}"><img src="https://img.icons8.com/color/search" width=15 height=15></a>
					<a href="${context}/maceta/r/${maceta.id}"><img src="https://img.icons8.com/color/48/000000/waste--v1.png" width=15 height=15/></a></td>
				</tr>
			</c:forEach>
		</table>
	</section>
